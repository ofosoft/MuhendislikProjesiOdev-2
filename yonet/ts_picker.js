function show_calendar(str_target, str_datetime) {
	var arr_months = ["Ocak", "Þubat", "Mart", "Nisan", "Mayýs", "Haziran",
		"Temmuz", "Aðustos", "Eylül", "Ekim", "Kasým", "Aralýk"];
	var week_days = ["Pa", "Pz", "Sa", "Ça", "Pe", "Cu", "Ct"];
	...
	str_buffer +=
		...
		"<font color=\"White\" face=\"tahoma, verdana\" size=\"2\">"+
		"Saat: <input type=\"text\" name=\"time\" value=\""+dt2tmstr(dt_datetime)+
...
function str2dt (str_datetime) {
	...
	if (!re_date.exec(str_datetime))
		return alert("Uyumsuz Tarih Formatý: "+ str_datetime);
