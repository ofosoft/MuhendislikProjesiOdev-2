...
<% 
 if Request.Form("paket_guncelle")<>"" then
	 ...
	 Rs.Open Sorgum, Baglantim, 1, 3 
		...
		rs.update
	Response.Write("<center>Paketi Güncelliyorum</center>")
 ...
 if rs.eof or rs.bof then%>
    	...
    	<div align="center"><a href="?kanal=ekle">Proje Bulunmamaktadýr. Eklemek Için Tiklayin. </a>
    	    <% if kanal="ekle" then
			rs.addnew
			rs("adi")="Yeni Proje"
			rs("goster")=0
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" >
  ...
  <tr>
    ...
    <td width="83"><div align="center"><strong>Satýþ</strong></div></td>
  ...
  <%
	...
	<%else
	Response.Write("Resim Yüklenmemiþ.")
	end if%>	</td>
  <td valign="middle">
...
<div align="center"><a href="?kanal=sil&amp;id=<%= rs("id") %>" onclick="return confirm('Dikkat! Paket Tamamen Silinecektir.')"><img src="images/sil.jpg"border="0"></a></div></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
      <tr>
        <td width="28%">Toplam<strong> <%=rs.recordcount %> </strong>Adet Kayýt Bulundu.</td>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="2">
    <tr>
      <td width="256"><div align="right" style="font-weight: bold">
        <div align="right">Sitede Göster : </div>
      </div></td>
    ...
    <tr>
      <td>
        <div align="right" style="font-weight: bold">Proje  Adý :</div>      </td>
      <td colspan="2">
      ...
      <td>&nbsp;</td>
      <td colspan="2"><input type="button" value="  Geri Dön  " onclick="history.go(-1)" style="width:100px; font-size:12px;font-weight:normal;color:#000000;text-decoration:none" /></td>
    </tr>
        <tr>
      <td><div align="right" style="font-weight: bold">
        <div align="right">Baþlama Tarihi : </div>
      </div></td>
      <td><input  name="baslama" type="text" class="footersmin" id="baslama" value="<%=rs("baslama")%>" size="18" maxlength="25"/></td>
      <td><div align="right" style="font-weight: bold">
        <div align="right">Bitiþ Tarihi : </div>
      </div></td>
    ...
    <tr>
     <td height="25" colspan="5" background="images/butonguncelle.png" style="border-radius:10px"><div align="center"><strong><font color="#FFFFFF">Projenin Kroki Kodu (http://maps.google.com dan Alýnabilir)</font></div></td>
     </tr>
     <tr>
     ...
     <td height="25" colspan="5" background="images/butonguncelle.png" style="border-radius:10px"><div align="center"><strong><font color="#FFFFFF">Projeye Ait Resimler</font></div></td>
        ...
        <img  onerror="src = '/ofosoft_img/resimyok.jpg'" src="<%if snc=0 then%>../<%end if%><%=rs("resim"&rss&"")%>" border="0" width="100" height="80"></a>
            ...
            <%end if%><br />
            <input name="Button" type="button" class="mbon" onClick="yenipencere('/ofosoft_editor/resimyukle.asp?id=<%= rs("id")%>&yer=resim<%=rss%>&klasor=paket','','resizable=yes,status=yes,width=800,height=600')" value="Resim Yükle" /></td>
         <%if i=10 then%></tr><tr>
         <%end if
		 next%>   
        <tr>
