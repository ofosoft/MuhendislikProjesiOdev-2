...
<%  
 if Request.Form("album_guncelle")<>"" then
 	 sorgum="select * from referans_kat where id="&id
 ...
 if id<>"" then
 	sorgum="select * from referans_kat where id="&id&" order by id desc"
 else
 	sorgum="select * from referans_kat order by id desc"
 end if
 Rs.Open Sorgum, Baglantim, 1, 3 
 if rs.eof or rs.bof then%>
<br />
    	<div align="center"><a href="?kanal=ekle">Kategori Bulunamadý. Eklemek Için Týklayýn. </a><br />
    	    <% if kanal="ekle" then
			rs.addnew
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" >
  ...
  <tr>
    <td colspan="5"><img src="../tema/images/bg_cizgi.gif" width="100%" height="11"></td>
  </tr>
  <%
  		if rs.eof or rs.bof then
  ...
  <td width="70"><div align="center"><a href="?kanal=guncelle&amp;id=<%= rs("id") %>"><img src="images/detay.jpg"border="0" /></a></div></td>
    ...
    <td colspan="5" height="8" align="center" background="../tema/images/kesik_cizgi.gif"></td>
  </tr>
	 <% 
      rs.movenext
	next%>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="30%">Toplam<strong> <%=rs.recordcount %> </strong>Adet Kategori Bulunmaktadýr. </td>
...
if kanal="sil" then %>
<% rs.close
	sorgum="delete * from referans_kat where id="&id
    Rs.Open Sorgum, Baglantim, 1, 3 
	Response.Redirect("giris.asp")
	 %>
