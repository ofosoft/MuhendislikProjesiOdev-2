...
'	katadi=parcala(3)
	Shf=request("shf")
	kat_id=request("id")
'	katadi2=Replace(katadi, ".html", "")
'	katadi2=Replace(katadi2, "_", " ")
%>
<!-- #include file="headic.asp" -->
<title><%galeri_baslik(kat_id)%> | <%=siteadi%></title>
...
<body>
  ...
  <tr>
	...
	<td valign="top"><!--#include file="resimgalerileri1.asp"--></td><td width="5"></td>
